...
class JobsDetailScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<JobsDetailScreen> createState() => _JobsDetailScreenState();
}

class _JobsDetailScreenState extends ConsumerState<JobsDetailScreen> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (item.company.isNotEmpty)
                        _overviewRow('Company', item.company),
                      ...
                      if (item.education.isNotEmpty)
                        _overviewRow('Education', item.education),
  ...
  void _shareItem() {
    ...
    final shareText =
        'Check out this job: $itemName - ${widget.item.formattedPrice} on Afghan Deals Pro';
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  Clipboard.setData(
                    ClipboardData(
                        text: 'afghan-deals-pro://jobs/${widget.item.id}'),
                  );
                  Navigator.pop(context);
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
