...
class _ElectronicsDetailScreenState
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (item.warranty.isNotEmpty)
                        _overviewRow('Warranty', item.warranty),
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(child: _whatsAppAction(onTap: () => openWhatsApp(context, item.phone))),
                  const SizedBox(width: 8),
                  Expanded(
  ...
  void _shareItem() {
    ...
    final shareText =
        'Check out this electronics item: $itemName - ${widget.item.formattedPrice} on Afghan Deals Pro';
              ...
              ListTile(
                ...
                onTap: () {
                  Clipboard.setData(
                    ClipboardData(
                        text:
                            'afghan-deals-pro://electronics/${widget.item.id}'),
                  );
                  Navigator.pop(context);
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
